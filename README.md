...
An application to upload/search photos from Flickr through FlickrAPI. JavaScript framework AngularJS is used to build user interface.
...
[2] https://embed.plnkr.co/PrzsognJp15GjbVSHWmR/<br/>
